...
export default function ContactTransmission() {
  return (
    <section className="bg-pm-navy-deeper text-white px-14 py-16">
      <div className="grid grid-cols-2 gap-17.5">
        <ContactInfo />
        <ContactForm />
      </div>
    </section>
...
function ContactInfo() {
  return (
    <div>
      <h2 className="m-0 text-[34px] font-bold tracking-[-0.6px]">
        Contact Transmission
      </h2>
      <p className="mt-5 mb-0 text-[15px] leading-[1.7] text-pm-contact-gray max-w-[430px]">
        Initiate technical consultation or request rapid equipment deployment
...
function ContactInfoItem({
  ...
  return (
    <div className="flex gap-4.5 items-start">
      <div
        className="w-10.5 h-10.5 shrink-0 flex items-center justify-center"
      ...
      <div>
        ...
        <div className="text-[13.5px] text-pm-contact-gray mt-1">
          {description}
        </div>
      </div>
    </div>
      ...
      <div className="grid grid-cols-2 gap-5.5">
        <FormField label="FULL NAME">
          <input
            ...
            className="mt-2.5 w-full text-white text-[14px] px-3.5 py-3.25 outline-none font-sans"
            style={inputStyle}
          />
        </FormField>
        ...
        <FormField label="DEPARTMENT">
          <div className="relative mt-2.5">
            <select
              ...
              className="appearance-none w-full text-white text-[14px] px-3.5 py-3.25 outline-none font-sans"
              style={inputStyle}
            >
      ...
      <div className="mt-5.5">
        <FormField label="TECHNICAL BRIEF">
          <textarea
            ...
            className="mt-2.5 w-full h-[120px] resize-none text-white text-[14px] px-3.5 py-3.25 outline-none font-sans"
            style={inputStyle}
          />
        </FormField>
      </div>
...
function FormField({
  ...
  return (
    <div>
      <label className="text-[11px] tracking-[1.2px] text-[#8c98a5] block">
        {label}
      </label>
      {children}
    </div>
