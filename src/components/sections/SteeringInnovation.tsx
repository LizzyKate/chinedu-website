...
export default function SteeringInnovation() {
  return (
    <section className="bg-pm-gray-light px-14 pt-14 pb-[60px]">
      <div className="flex items-start justify-between gap-10">
        <div>
          <h2 className="m-0 text-[30px] font-bold tracking-[-0.5px] text-pm-navy">
            Steering Innovation
          </h2>
          <p className="mt-[14px] mb-0 text-[15px] leading-[1.6] text-pm-gray-mid max-w-[440px]">
        ...
        <a
          href="#"
          className="bg-pm-navy text-white text-xs font-bold tracking-[1px] px-[26px] py-[15px] no-underline whitespace-nowrap shrink-0"
        >
          VIEW ALL LEADERSHIP
        </a>
      </div>
...
function TeamMemberCard({
  ...
  return (
    <div>
      ...
      <h3 className="mt-[22px] mb-[5px] text-[21px] font-bold tracking-[-0.3px] text-pm-navy">
        {name}
      </h3>
